...
- **Atlas overview** — home hubs + destination constellation + hub→destination spokes; destination-grouped trip list
- **Memory reel** — atlas quietly cycles featured journeys until you pick one (Pause anytime)
